...
const AFrameModal = props => (
	<div>
		...
		<p> From 2017-2018, I made a bunch of experiments in WebVR using the <a href="https://aframe.io/">AFrame library</a>. AFrame allows you to write reusable webVR components using standard frontend languages. The following webpages will work in any browser, but work best on a mobile phone and are enhanced by using a Google Cardboard headset. </p>

		<p className="card__modal_title"> <a href="https://sleepytime.glitch.me/">sleepytime</a> </p>
